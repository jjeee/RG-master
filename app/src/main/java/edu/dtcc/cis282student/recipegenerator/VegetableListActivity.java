        ...
        switch (view.getId()){
            ...
            case R.id.btn_veg_2:
                if (CategoryListActivity.ingredientsList[10] == null) {
                    CategoryListActivity.ingredientsList[10] = "carrot";
                    bolArray[1] = true;
                    view.setSelected(true);
                } else {
            ...
            case R.id.btn_veg_3:
                if (CategoryListActivity.ingredientsList[11] == null) {
                    CategoryListActivity.ingredientsList[11] = "tomato";
                    bolArray[2] = true;
                    view.setSelected(true);
                } else {
            ...
            case R.id.btn_veg_4:
                if (CategoryListActivity.ingredientsList[12] == null) {
                    CategoryListActivity.ingredientsList[12] = "bell pepper";
                    bolArray[3] = true;
                    view.setSelected(true);
                } else {
            ...
            case R.id.btn_veg_5:
                if (CategoryListActivity.ingredientsList[13] == null) {
                    CategoryListActivity.ingredientsList[13] = "corn";
                    bolArray[4] = true;
                    view.setSelected(true);
                } else {
            ...
            case R.id.btn_veg_6:
                if (CategoryListActivity.ingredientsList[14] == null) {
                    CategoryListActivity.ingredientsList[14] = "potato";
                    bolArray[5] = true;
                    view.setSelected(true);
                } else {
            ...
            case R.id.btn_veg_7:
                if (CategoryListActivity.ingredientsList[15] == null) {
                    CategoryListActivity.ingredientsList[15] = "onion";
                    bolArray[6] = true;
                    view.setSelected(true);
                } else {
            ...
            case R.id.btn_veg_8:
                if (CategoryListActivity.ingredientsList[16] == null) {
                    CategoryListActivity.ingredientsList[16] = "kidney beans";
                    bolArray[7] = true;
                    view.setSelected(true);
                } else {
            ...
            case R.id.btn_veg_9:
                if (CategoryListActivity.ingredientsList[17] == null) {
                    CategoryListActivity.ingredientsList[17] = "lettuce";
                    bolArray[8] = true;
                    view.setSelected(true);
                } else {
